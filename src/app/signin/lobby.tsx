...
const Welcome = () => (
  <div className="hidden md:flex items-center justify-center pt-32 pb-4">
    <div className="relative left-[50px] overflow-clip md:rounded-2xl h-full w-full">
      ...
      <XGrid>
        <div className="bg-gradient-to-r from-transparent from-65% to-amber-500/20 justify-center items-center h-full w-full flex flex-col">
          <div className="bg-[url('/svg/caesar_gold_v1.svg')] opacity-70 bg-contain bg-no-repeat bg-center relative right-[75px] h-[260px] w-[260px]" />
          <div className="h-[100px] relative right-[75px] flex items-start">
          ...
          <div className="h-[200px] w-[300px] text-center max-w-[26ch] relative right-[75px]">
            <span className="text-blue-100/70 text-[14px] font-sans ">Your data is protected using our end-to-end encryption and unique keys. Our cybersecurity team are constantly monitoring all data transmissions with zero-knowledge proofs, ensuring we provide the highest quality of privacy protection.</span>
          </div>
...
const TopSection = () => (
  <div className="flex md:items-end items-center row-span-1 md:px-24 px-6 w-full justify-between">
    <div className="flex flex-col">
      <h1 className="md:text-5xl text-3xl font-sans font-bold text-blue-950 tracking-tighter">Create new account.</h1>
...
const SignCards = ({ onClick }: CardProps) => {
  return (
    <div className="md:overflow-x-scroll py-2 h-fit w-screen md:w-full">
      <div className="md:px-24 px-6 md:gap-x-12 gap-x-4 grid grid-cols-2 w-[800px] md:w-full">
...
const ActiveLogin = ({ onClick }: CardProps) => {
  return (
      ...
      <div className="flex items-center w-full col-span-2">
        <LoginWrap>
          <div className="flex justify-end">
            <Button onClick={onClick} className="hover:bg-blue-500/10 text-orange-50 hover:text-blue-500" size='icon' variant='ghost'>
              <XIcon className="" />
            </Button></div>
          <div className="flex items-center justify-between">
            <h2 className="text-blue-950 font-sans font-medium tracking-tighter text-3xl">Sign up with email.</h2>
          </div>
...
const MidSection = () => {
  ...
  const handleToggle = () => toggleState(setActive)
  const ViewOptions = useCallback(() => {
    const options = opts(<ActiveLogin onClick={handleToggle} />, <SignCards onClick={handleToggle} />)
