...
export const Container = tw.div`
  h-[calc(100vh-46px)] flex justify-start w-full
  bg-gradient-to-br from-zap from-40% via-blue-400/20 to-zap to-100%
  `;

export const Inner = tw.div`
  h-[calc(100vh-46px)] flex flex-col
  `;

export const Aside = tw.aside`
  lg:h-full lg:w-[250px] lg:bg-[#e6e6e6]
  lg:border-r-[1.0px] z-50 border-ash bg-ghost
...
export const BodyWrap = tw.div`
  ...
  w-[calc(100vw-230px)] overflow-x-scroll
  `;
...
export const ItemContent = tw.div`
  flex h-[46px] w-fit items-center
  `;
