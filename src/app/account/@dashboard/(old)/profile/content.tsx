      ...
      <div className="space-y-6 px-8 md:px-44">
        ...
        <div className="flex items-center space-x-6">
          <div className="flex items-center space-x-1">
            ...
            <p className="text-xs text-coal">{profile?.email}</p>
          </div>
          {profile?.userData?.address?.line1 ? (
            <div className="flex items-center space-x-1">
              <MapPinnedIcon className="h-3 w-3 text-clay" />
              <p className="text-xs text-clay">
                {profile?.userData?.address?.city}
              </p>
            </div>
          ) : null}
          ...
          <div className="flex items-center space-x-1">
            ...
            <p className="text-xs text-clay">{profile?.createdAt}</p>
          </div>
        </div>
